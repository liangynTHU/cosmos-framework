TRAINING_NAME=ep0_5_full_traj_concat_view_global_bs64_32k_lr2e-5_steps_warmup1k \
...
OPTIMIZER_LR=2e-5 SCHEDULER_F_MAX=1.0 SCHEDULER_F_MIN=0.0 SCHEDULER_WARM_UP_STEPS=1000 \
...
WANDB_NAME=cosmos3nano_robotwin_ep0_5_full_traj_concat_view_global_bs64_32k_steps_warmup1k_$(date +%Y%m%d_%H%M%S) \
