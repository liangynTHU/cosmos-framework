TRAINING_NAME=ep0_5_full_traj_concat_view_global_bs32_32k_lr3e-4_steps_warmup1k \
...
OPTIMIZER_LR=3e-4 SCHEDULER_F_MAX=1.0 SCHEDULER_F_MIN=0.0 SCHEDULER_WARM_UP_STEPS=1000 \
...
WANDB_NAME=cosmos3nano_robotwin_ep0_5_full_traj_concat_view_global_bs32_32k_steps_warmup1k_$(date +%Y%m%d_%H%M%S) \
OUTPUT_BASE_ROOT=/apdcephfs_gy7/share_303588738/hunyuan/yinanliang/wam/cosmos3/outputs/train_robotwin_cosmos3nano \
MAX_ITER=32000 SAVE_ITER=100 \
