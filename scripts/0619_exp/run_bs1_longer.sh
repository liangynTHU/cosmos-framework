TRAINING_NAME=ep0_5_full_traj_concat_view_global_bs64_32k_steps_warmup1k \
...
OPTIMIZER_LR=2.0e-4 SCHEDULER_F_MAX=1.0 SCHEDULER_F_MIN=0.0 SCHEDULER_WARM_UP_STEPS=1000 \
