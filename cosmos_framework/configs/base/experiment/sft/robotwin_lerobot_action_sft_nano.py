...
"""RoboTwin LeRobot single-camera Action SFT smoke recipe for Cosmos3-Nano."""
...
robotwin_lerobot_action_sft_nano = LazyDict(
    dict(
        ...
        optimizer=dict(
            ...
            lr=2.0e-05,
            lr_multipliers={"action_modality_embed": 5.0},
        ...
        trainer=dict(
            ...
            callbacks=dict(
                ...
                dataloader_speed=dict(every_n=1, save_s3=False, step_size=1),
                device_monitor=dict(every_n=100, log_memory_detail=True, save_s3=False, step_size=1, upload_every_n_mul=5),
                ...
                sigma_loss_analysis=dict(every_n=100, every_n_viz=100, save_s3=False),
